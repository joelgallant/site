...
The biggest challenge of this job was developing a sustainable platform with new, flexible requirements, while continuing to deliver projects for clients.
The platform is flexible to deploy many different applications, with one single code base.
This is all aided by the build system and infrastructure that I played a critical role in creating.
