...
### Trace Visual Intelligence

I joined the software team for Trace to create a realtime object tracker onboard our own quadcopters.
My work outperformed the best openly available options in accuracy and performance, at the time.
